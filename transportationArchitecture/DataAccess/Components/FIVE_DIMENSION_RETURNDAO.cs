...
{
    public class FIVE_DIMENSION_RETURNDAO :DataAccess.Framework.AbstractDAO
    {
        #region Constructor
        public FIVE_DIMENSION_RETURNDAO()
        {
        ...
        protected override string SelectCommand
        {
            get
            {
                return "PKJ_SELECT.SELECTFIVE_DIMENSION_RETURN";
            }
        }
        ...
        protected override string InsertCommand
        {
            get
            {
                return "PKJ_MODIFY.MODIFYFIVE_DIMENSION_RETURN";
            }
        }
		...
		protected override IDbDataParameter[] CreateInsertParameters(EntityBase anEntity)
        {
            FIVE_DIMENSION_RETURN theEntity = (FIVE_DIMENSION_RETURN)anEntity;
			List<IDbDataParameter> cmdParams = new List<IDbDataParameter>();
            cmdParams.Add(DataAccessFactory.CreateDataParameter("VAR_mode","i"));
		...
		protected override IDbDataParameter[] CreateUpdateParameters(EntityBase anEntity)
        {
            FIVE_DIMENSION_RETURN theEntity = (FIVE_DIMENSION_RETURN)anEntity;
            List<IDbDataParameter> cmdParams = new List<IDbDataParameter>();
            cmdParams.Add(DataAccessFactory.CreateDataParameter("VAR_mode","u"));
		...
		protected override IDbDataParameter[] CreateDeleteParameters(EntityBase anEntity)
        {
            FIVE_DIMENSION_RETURN theEntity = (FIVE_DIMENSION_RETURN)anEntity;
            List<IDbDataParameter> cmdParams = new List<IDbDataParameter>();
            cmdParams.Add(DataAccessFactory.CreateDataParameter("VAR_mode","d"));
