...
{
    public class VEHICLE_DAKHILADAO :DataAccess.Framework.AbstractDAO
    {
        #region Constructor
        public VEHICLE_DAKHILADAO()
        {
        ...
        protected override string SelectCommand
        {
            get
            {
                return "PKJ_SELECT.SELECTVEHICLE_DAKHILA";
            }
        }
        ...
        protected override string InsertCommand
        {
            get
            {
                return "PKJ_MODIFY.MODIFYVEHICLE_DAKHILA";
            }
        }
        ...
        {
			VEHICLE_DAKHILA theEntity = new VEHICLE_DAKHILA();
        ...
        {
            VEHICLE_DAKHILA theEntity = (VEHICLE_DAKHILA)anEntity;
