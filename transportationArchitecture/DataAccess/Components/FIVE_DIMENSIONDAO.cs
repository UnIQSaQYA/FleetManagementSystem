...
{
    public class FIVE_DIMENSIONDAO :DataAccess.Framework.AbstractDAO
    {
        #region Constructor
        public FIVE_DIMENSIONDAO()
        {
        ...
        protected override string SelectCommand
        {
            get
            {
                return "PKJ_SELECT.SELECTFIVE_DIMENSION";
            }
        }
        ...
        protected override string InsertCommand
        {
            get
            {
                return "PKJ_MODIFY.MODIFYFIVE_DIMENSION";
            }
        }
        ...
        {
			FIVE_DIMENSION theEntity = new FIVE_DIMENSION();
        ...
        {
            FIVE_DIMENSION theEntity = (FIVE_DIMENSION)anEntity;
