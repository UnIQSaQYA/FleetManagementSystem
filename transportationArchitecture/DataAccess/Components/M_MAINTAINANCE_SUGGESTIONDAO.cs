...
{
    public class M_MAINTAINANCE_SUGGESTIONDAO :DataAccess.Framework.AbstractDAO
    {
        #region Constructor
        public M_MAINTAINANCE_SUGGESTIONDAO()
        {
        ...
        protected override string SelectCommand
        {
            get
            {
                return "PKJ_SELECT.SELECTM_MAINTAINANCE_SUGGEST";
            }
        }
        ...
        protected override string InsertCommand
        {
            get
            {
                return "PKJ_MODIFY.MODIFYM_MAINTAINANCE_SUGGEST";
            }
        }
        ...
        {
			M_MAINTAINANCE_SUGGESTION theEntity = new M_MAINTAINANCE_SUGGESTION();
        ...
        {
            M_MAINTAINANCE_SUGGESTION theEntity = (M_MAINTAINANCE_SUGGESTION)anEntity;
